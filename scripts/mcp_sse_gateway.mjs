...
const HMAC_REDACTED_BY_AUDIT_ISSUE_70 = process.env.MCP_SSE_HMAC_REDACTED_BY_AUDIT_ISSUE_70 || ''; // optional additional integrity signature
...
function hmacSignature(payload) {
  if (!HMAC_REDACTED_BY_AUDIT_ISSUE_70) return null;
  return crypto.createHmac('sha256', HMAC_REDACTED_BY_AUDIT_ISSUE_70).update(payload).digest('hex');
}
