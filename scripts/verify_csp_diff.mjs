...
const STRICT_DIRS = ['default-src','script-src','style-src','object-src','frame-ancestors','base-uri','form-action'];
function tokenize(val){return val.split(/\s+/).filter(Boolean).sort();}
